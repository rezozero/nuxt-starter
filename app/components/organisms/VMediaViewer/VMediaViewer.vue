...
.root {
    --v-img-height: #{calc(100% - #{px-to-rem(262)})};
...
.copyright {
    --v-copyright-right: #{px-to-rem(20)};
    --v-copyright-bottom: #{px-to-rem(26)};

    @include media('>=md') {
        --v-copyright-right: #{px-to-rem(32)};
        --v-copyright-bottom: #{px-to-rem(32)};
    }
}
</style>
